...
export const useCreatePost=()=>{
    ...
    return useMutation({
        ...
        onSuccess:()=>{
            //jab bhi hum new post add krenge, our app will fetch 
            // recent posts from server rather than cache
...
export const useSearchPosts = (searchTerm: string) => {
    return useQuery({
      ...
      enabled: !!searchTerm,//when is it going to automatically refetch
    });
};
